...
return (
    ...
    {lovedItems.length === 0 ? (
        ...
        return (
            <div
                key={id} className="rounded-2xl overflow-hidden flex flex-col border border-gray-200 dark:border-white/10 bg-white dark:bg-black shadow-sm dark:shadow-black/40 hover:shadow-lg transition-colors">
                {/* Imagen + overlays */}
